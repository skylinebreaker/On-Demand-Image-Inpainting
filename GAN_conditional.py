...
def save_results(results, batch_samples, valid_test):
    ...
    if valid_test == 1:
    	...
    	result_path = "./valid_images_1234"
    else:
        result_path = "./train_images"
...
class GANModel():
    ...
    def _init_ops(self):
        ...
        gen_loss_L1 = tf.reduce_mean(tf.abs(self.real_label - self.result))
        self.gen_loss_op = gen_loss_GAN * self.gan_weight + gen_loss_L1 * self.l1_weight
